...
@section('content')
    <div class="container" style="direction: rtl; font-family: Yekan">
        ...
        <form action="/d/month/debtsretrieveprocess" method="post">
            @csrf
        <div class="row text-right">
            <div class="col-8 offset-2">
                ...
                <div class="form-group row">
                    <label for="debtsmonth" class="col-md-4 col-form-label text-md-right">ماه مورد نظر</label>

                    <div class="col-md-6">
                        <select class="form-control" name="debtsmonth" id="debtsmonth">
