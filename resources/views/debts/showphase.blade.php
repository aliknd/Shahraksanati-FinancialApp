        ...
        <div class="row border" style="margin-bottom: 10px">
            ...
            <div class="col-4">
                <div class="table-responsive pt-4">
                    ...
                    <table class="table table-striped table-bordered text-center table-sm" style="line-height: 16px">
                        ...
                        <tr>
                            <td>
                                {{ $lastdebtshowcost+$userfinhistory->userdebt }}
                            </td>
                            <td class="font-weight-bold" style="font-size: 12px;">
                                بدهی قبلی
                            </td>
                        ...
                        <tr>
                            <td class="bg-primary font-weight-bold" style="font-size: 16px;">
                                {{ round($debt->totalcost+$lastdebtshowcost-$userfinhistory->usercredit+$userfinhistory->userdebt, -3) }}
                            </td>
                        ...
                        <tr>
                            <td class="bg-primary font-weight-bold" style="font-size: 11px;">
                                {{ mablagh(round($debt->totalcost+$lastdebtshowcost-$userfinhistory->usercredit+$userfinhistory->userdebt, -3)) }}
                            </td>
                            <td class="bg-success font-weight-bold" style="direction: rtl; font-size: 12px;">
                                مبلغ (به حروف)
                            </td>
            ...
            <div class="col-8">
                ...
                <div class="table-responsive pt-4">
                    ...
                    <table class="table table-striped table-bordered text-center table-sm">
                        ...
                        <tr>
                            <td>
                                {{ $debt->user->nationalid . $debt->user->businessid }}
                            </td>
                            <th class="bg-primary">
                    ...
                    <div class="text-right bg-white" style="direction:rtl; height: 110px; border: 1px solid gray; border-radius: 10px; margin-top: 10px; margin-bottom: 10px; padding-right: 8px;">
                        توضیحات:
                        <div class="text-danger"> {{ $ekhtar }} </div> <br>
                        <div class="text-dark"> شماره پشتیبانی: 03833338530 </div>
                    </div>
