            ...
            <table class="table table-striped table-bordered text-center">
                ...
                <tbody>
                    @foreach($debts as $debt)
                        ...
                        <td>@if($debt->paymentstatus == 'false') <a href="/dsamaneh/{{ $debt->id }}" style="color: red">پرداخت نشده - مشاهده فاکتور</a> @else <a href="/dsamaneh/{{ $debt->id }}" style="color: green">پرداخت شده - مشاهده فاکتور</a> @endif</td>
